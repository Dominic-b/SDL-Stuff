...
/*
Things to fix: 
collision detection - dot sometimes stops and is unable to go right next to a surface due to the way in which it is handled, 

jumping currently line 286 - only being able to be done from the ground, 

hitbox of the dot isnt completely accurate as it converts a double - of the dots images position to an int - the dots hitbox position

when pressing s while on the ground the player jumps up 
*/
...
void Dot::handleEvent(SDL_Event& e)
{
	...
	if (e.type == SDL_KEYDOWN && e.key.repeat == 0)
	{
		...
		{
			//currently how jumping is handled \/
			case SDLK_SPACE: mVelY -= .5 * DOT_VEL; break;
...
bool loadMedia()
{
	...
	//Load press texture
	if (!gDotTexture.loadFromFile("DOT (1).png"))
	{
